package com.hibernate.xml.collectionsMappings.map;
	...
	public static void main(String[] args) {
		try {
			factory = new Configuration()
					.configure("com/hibernate/xml/collectionsMappings/map/hibernate.cfg.xml")
					.buildSessionFactory();
		} catch (Throwable ex) {
	...
	public void listEmployees() {
		...
		try {
			...
			for (Iterator iterator1 = employees.iterator(); iterator1.hasNext();) {
				...
				System.out
						.println("Certificate: "
								+ (((Certificate) ec.get("ComputerScience"))
										.getName()));
				System.out.println("Certificate: "
						+ (((Certificate) ec.get("BusinessManagement"))
								.getName()));
				System.out.println("Certificate: "
						+ (((Certificate) ec.get("ProjectManagement"))
								.getName()));
			}
			tx.commit();
		} catch (HibernateException e) {
